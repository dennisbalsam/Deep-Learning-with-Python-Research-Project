...
for i in range(3):
    ...
    meanX = sum(X[i]) / X[i].shape[0]
    stdevX = ((sum(X[i] - meanX)) ** 0.5) / X[i].shape[0]
    X[i] = (X[i] - meanX) / stdevX
    print(X[i])
...
model.save('flowers-augmentation-2-standardization.h5')
...
# save to json:
hist_json_file = 'C:/Users/dkrup/OneDrive/Documents/CSI CSC Courses/Deep-Learning-with-Python-Research-Project/Flowers-Model-Code/flowers-code/updated-flower-models/flowers-2-augmentation/flowers-aug-standardization/history.json'
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# or save to csv:
hist_csv_file = 'C:/Users/dkrup/OneDrive/Documents/CSI CSC Courses/Deep-Learning-with-Python-Research-Project/Flowers-Model-Code/flowers-code/updated-flower-models/flowers-2-augmentation/flowers-aug-standardization/history.csv'
