...
base_dir = 'C:/Users/dkrup/OneDrive/Documents/CSI CSC Courses/Deep-Learning-with-Python-Research-Project/Flowers-Model-Code/flowers-new-distrub-lr'
# os.mkdir(base_dir)
...
#             if (i < int((current_class_size / 1.54))):
#                 src = os.path.join(data, folder, file)
#                 dst = os.path.join(train_dir, folder, file)
#                 shutil.copyfile(src, dst)
#             elif(i < (current_class_size - (int(current_class_size / 6.6)))):
#                 src = os.path.join(data, folder, file)
...
#output totals before oversampling
...
model.save('flowers-oversampling-newlr.h5')
...
# save to json:
hist_json_file = 'C:/Users/dkrup/OneDrive/Documents/CSI CSC Courses/Deep-Learning-with-Python-Research-Project/Flowers-Model-Code/flowers-code/updated-flower-models/new-set-distribution/oversampling-new-lr/history.json'
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# or save to csv:
hist_csv_file = 'C:/Users/dkrup/OneDrive/Documents/CSI CSC Courses/Deep-Learning-with-Python-Research-Project/Flowers-Model-Code/flowers-code/updated-flower-models/new-set-distribution/oversampling-new-lr/history.csv'
