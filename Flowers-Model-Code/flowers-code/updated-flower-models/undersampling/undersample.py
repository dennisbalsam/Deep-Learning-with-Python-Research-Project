...
base_dir = 'C:/Users/denni/Documents/CSI-Courses/CSC450/Flowers-Model-Code/flowers-code/updated-flower-models/oversampling/flowers-2'
# os.mkdir(base_dir)
#
...
#undersample the sets based on the minority class
from imblearn.under_sampling import RandomUnderSampler
rus = RandomUnderSampler(random_state=0, replacement=True)
train, train_labels = rus.fit_sample(train_matrix, train_labels)
validation, validation_labels = rus.fit_sample(validation_matrix, validation_labels)
...
model.save('flowers-undersampling.h5')
...
# save to json:
hist_json_file = 'C:/Users/denni/Documents/CSI-Courses/CSC450/Flowers-Model-Code/flowers-code/updated-flower-models/undersampling/history.json'
with open(hist_json_file, mode='w') as f:
    hist_df.to_json(f)

# or save to csv:
hist_csv_file = 'C:/Users/denni/Documents/CSI-Courses/CSC450/Flowers-Model-Code/flowers-code/updated-flower-models/undersampling/history.csv'
